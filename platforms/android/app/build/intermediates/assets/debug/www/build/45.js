...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(466);
  ...
  */
        ...
        this.apiProvider.getCentroInfo(dataPost)
            ...
            if (data) {
                ...
                _this.comentarios.forEach(function (comm) {
                    if (comm.idFoto)
                        _this.filteredComments.push(comm.idFoto);
                });
    ...
    PerfilCentroPage.prototype.llamarCell = function () {
        if (this.dataCentro.celular) {
            var num = this.dataCentro.celular;
            window.plugins.CallNumber.callNumber(function (suc) { console.log(suc); }, function (err) { console.log(err); }, num, true);
        }
    };
    PerfilCentroPage.prototype.openWhatsApp = function () {
        window.open('https://wa.me/' + this.dataCentro.celular, '_system');
    };
