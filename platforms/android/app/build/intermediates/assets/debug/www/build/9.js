...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__perfil_centro__ = __webpack_require__(499);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(468);
...
var PerfilCentroPage = (function () {
    function PerfilCentroPage(navCtrl, alertCtrl, DomSanitizer, navParams, http, modalCtrl, apiProvider, loadingController, events, zone, plt) {
  ...
  */
    ...
    PerfilCentroPage.prototype.loadMap = function () {
        var _this = this;
        if (!this.map) {
            setTimeout(function () {
                ...
                _this.map = plugin.google.maps.Map.getMap(element, {
                    ...
                    'camera': {
                        target: { lat: _this.dataCentro.latitud, lng: _this.dataCentro.longitud },
                        zoom: 15
                    },
                    'preferences': {
                        'zoom': {
                ...
                _this.map.one(plugin.google.maps.event.MAP_READY, function () {
                    _this.map.addMarker({
                        'position': { lng: _this.dataCentro.longitud, lat: _this.dataCentro.latitud },
    ...
    PerfilCentroPage.prototype.getCentroInfo = function (idCentro) {
        ...
        this.apiProvider.getCentroInfo(dataPost)
            ...
            if (data) {
                ...
                _this.comentarios.forEach(function (comm) {
                    if (comm.idFoto)
                        _this.filteredComments.push(comm);
                });
    ...
    PerfilCentroPage.prototype.filterBanners = function () {
        var _this = this;
        this.filteredBanners = [];
        this.banners.forEach(function (banner) {
            if (_this.dataCentro['imagenBanner' + banner])
                _this.filteredBanners.push(_this.dataCentro['imagenBanner' + banner].replace("\\", "/"));
        });
    };
    ...
    PerfilCentroPage.prototype.comoLlegar = function () {
    ...
    PerfilCentroPage.prototype.llamar = function () {
        ...
        if (this.dataCentro.telefono) {
            var num = '+' + this.dataCentro.codigo_pais_telefono + this.dataCentro.telefono;
            window.plugins.CallNumber.callNumber(function (suc) { console.log(suc); }, function (err) { _this.callAlert(err); }, num, true);
        }
    };
    PerfilCentroPage.prototype.llamarCell = function () {
        var _this = this;
        if (this.dataCentro.celular) {
            var num = '+' + this.dataCentro.codigo_pais_celular + this.dataCentro.celular;
            window.plugins.CallNumber.callNumber(function (suc) { console.log(suc); }, function (err) { _this.callAlert(err); }, num, true);
        }
    };
    PerfilCentroPage.prototype.callAlert = function (err) {
        var alert = this.alertCtrl.create({
            title: 'Debes autorizar a YourBeauty a hacer llamadas',
            enableBackdropDismiss: true
        });
        alert.present();
    };
    PerfilCentroPage.prototype.openWhatsApp = function () {
        window.open('https://wa.me/' + this.dataCentro.codigo_pais_celular + this.dataCentro.celular, '_system');
    };
